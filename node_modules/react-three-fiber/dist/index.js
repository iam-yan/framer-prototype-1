...
import { Vector2, Raycaster, Scene, OrthographicCamera, PerspectiveCamera, WebGLRenderer, Vector3, Math as Math$1 } from 'three';
...
const Canvas = memo((_ref2) => {
  ...
  const state = useRef({
    ...
    setDefaultCamera: cam => _setDefaultCamera(cam),
  ...
  useEffect(() => {
    ...
    state.current.canvas = canvas.current; // Start render-loop, either via RAF or setAnimationLoop for VR
